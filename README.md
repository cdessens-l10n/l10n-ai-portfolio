# AI workflows for language management
...
1. **Product UI review autopilot** — AI workflow + batch CLI that reviews every EN→FR Product UI segment in scoped TMS jobs, scores confidence, uploads reviewed bilingual files, and auto-completes only on clean Pass (score 100 + hard gates). Hold jobs stay with humans; ~80% of source words in a typical batch still need human finish (1–18 Sep 2026).
